...
key为第一组数据中的key值。
value对象中down.type的值为"audio_files",   down.value.name_id与第一组数据中value名称在第二组数据中name内所对应的数字相等, down.value.sha256与第一组数据中value名称在第二组数据name中对应并取第二组数据的key值作为其值, down.value.type与第一组数据中value名称在第二组数据name中对应并取第二组数据的type的值作为其值。
...
```json
{
  "14": {
    "down": {
      ...
      "value": {
        "name_id": "0",
        "sha256": "e9f1fe1c641487bff608cf3dca8b5acb8c75835163515e14517c60bb65d1b14f",
        "type": ".wav"
      }
    },
    "up": {
  ...
  "22": {
    "down": {
      ...
      "value": {
        "name_id": "0",
        "sha256": "f1a80d1973de3c5b0d72ca302006fd9dec14d380fe8fa0b1689394284676925a",
        "type": ".wav"
      }
    },
    "up": {
  ...
  "57": {
    "down": {
      ...
      "value": {
        "name_id": "0",
        "sha256": "5b243a471e2e7d294a6bf30c53417abb63edb1b1cc8c9b2c4d098c1bed169a53",
        "type": ".wav"
      }
    },
    "up": {
